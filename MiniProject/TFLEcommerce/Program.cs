...
class directconnectivity
{
    ...
    static void Main()
    {
        string connectionString = "Server=localhost;Port=3307;Database=sample;User=root;Password=root; ";
      using(MySqlConnection connection = new MySqlConnection(connectionString))
      {
            try
            {
                ...
                InsertUser(connection, "Sanika kulkarni", "Sanika@tfl.com");
                InsertUser(connection, "Sejal kulkarni", "Sejal@tfl.com");
                UpdateUserEmail(connection, "vedant Patil", "vedant@tfl.com");
